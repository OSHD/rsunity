...
namespace Ionic.Zlib
{
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            // UnityEngine.Debug.Log("GZipStream::Read(buffer, off({0}), c({1}) = {2}", offset, count, n);
            // UnityEngine.Debug.Log( Util.FormatByteArray(buffer, offset, n) );
		...
		{
			if (_disposed) throw new ObjectDisposedException("GZipStream");
			int n = _baseStream.Read2(buffer, offset, count);
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            {
                //UnityEngine.Debug.Log("GZipStream: First write");
