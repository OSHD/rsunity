...
//			tile_layer0_type = NetDrawingTools.CreateTrippleByteArray (4, anInt146, anInt147);//new byte[4][anInt146][anInt147];
//			tile_layer1_type = NetDrawingTools.CreateTrippleByteArray (4, anInt146, anInt147);//new byte[4][anInt146][anInt147];
//			tile_layer1_shape = NetDrawingTools.CreateTrippleByteArray (4, anInt146, anInt147);//new byte[4][anInt146][anInt147];
//			tile_layer1_orientation = NetDrawingTools.CreateTrippleByteArray (4, anInt146, anInt147);//new byte[4][anInt146][anInt147];
//			tile_layer0_colour = NetDrawingTools.CreateTrippleIntArray(4, anInt146, anInt147);
//			anIntArrayArrayArray135 = NetDrawingTools.CreateTrippleIntArray (4, anInt146 + 1, anInt147 + 1);//new int[4][anInt146 + 1][anInt147 + 1];
//			aByteArrayArrayArray134 = NetDrawingTools.CreateTrippleByteArray (4, anInt146 + 1, anInt147 + 1);//new byte[4][anInt146 + 1][anInt147 + 1];
//			anIntArrayArray139 = NetDrawingTools.CreateDoubleIntArray (anInt146 + 1, anInt147 + 1);//int[anInt146 + 1][anInt147 + 1];
...
//		}
//		
//		public void method171(CollisionMap[] aclass11,
...
//				
//			}
//			anInt123 += (int) (Random.Next() * 5D) - 2;
//			if (anInt123 < -8)
//				anInt123 = -8;
//			if (anInt123 > 8)
//				anInt123 = 8;
//			/*anInt133 += (int) (Random.Next() * 5D) - 2;
//		if (anInt133 < -16)
//			anInt133 = -16;
//		if (anInt133 > 16)
//			anInt133 = 16;*/
...
//				sbyte byte2 = -10;
//				sbyte byte3 = -50;
//				int j3 = (int) UnityEngine.Mathf.Sqrt(byte1 * byte1 + byte2 * byte2 + byte3
//				                         * byte3);
//				int l3 = c * j3 >> 8;
//				for (int j4 = 1; j4 < anInt147 - 1; j4++) {
//					for (int j5 = 1; j5 < anInt146 - 1; j5++) {
//						int k6 = anIntArrayArrayArray129[z][j5 + 1][j4]
//						- anIntArrayArrayArray129[z][j5 - 1][j4];
//						int l7 = anIntArrayArrayArray129[z][j5][j4 + 1]
//						- anIntArrayArrayArray129[z][j5][j4 - 1];
//						int j9 = (int) UnityEngine.Mathf.Sqrt(k6 * k6 + 0x10000 + l7 * l7);
//						int k12 = (k6 << 8) / j9;
//						int l13 = 0x10000 / j9;
//						int j15 = (l7 << 8) / j9;
...
//				
//				
//				for (int tile_x = -5; tile_x < anInt146 + 5; tile_x++) {
//					for (int i8 = 0; i8 < anInt147; i8++) {
//						int k9 = tile_x + 5;
//						if (k9 >= 0 && k9 < anInt146) {
//							int l12 = tile_layer0_type[z][k9][i8] & 0xff;
//							if (l12 > 0) {
...
//							int i14 = tile_layer0_type[z][i13][i8] & 0xff;
//							if (i14 > 0) {
...
//					
//					
//					if (tile_x >= 1 && tile_x < anInt146 - 1) {
//						int l9 = 0;
//						int j13 = 0;
//						int j14 = 0;
//						int k15 = 0;
//						int k16 = 0;
//						for (int tile_y = -5; tile_y < anInt147 + 5; tile_y++) {
//							int j18 = tile_y + 5;
...
//							    && tile_y < anInt147 - 1
//							    && (!lowMem
//							    || (aByteArrayArrayArray149[0][tile_x][tile_y] & 2) != 0 || (aByteArrayArrayArray149[z][tile_x][tile_y] & 0x10) == 0
//							    && method182(tile_y, z, tile_x) == anInt131)) {
//								if (z < anInt145)
//									anInt145 = z;
//								int underlay = tile_layer0_type[z][tile_x][tile_y] & 0xff;
//								int overlay = tile_layer1_type[z][tile_x][tile_y] & 0xff;
//								if (underlay > 0 || overlay > 0) {
//									int j19 = anIntArrayArrayArray129[z][tile_x][tile_y];
//									int k19 = anIntArrayArrayArray129[z][tile_x + 1][tile_y];
//									int l19 = anIntArrayArrayArray129[z][tile_x + 1][tile_y + 1];
//									int i20 = anIntArrayArrayArray129[z][tile_x][tile_y + 1];
//									int j20 = anIntArrayArray139[tile_x][tile_y];
//									int k20 = anIntArrayArray139[tile_x + 1][tile_y];
//									int l20 = anIntArrayArray139[tile_x + 1][tile_y + 1];
//									int i21 = anIntArrayArray139[tile_x][tile_y + 1];
//									int colour = 0;
//									int j21 = -1;
//									int k21 = -1;
//									if (underlay > 0) {
...
//										colour = Flo.cache[underlay - 1].rgb;
//									}
//									if (z > 0) {
//										bool flag = true;
//										if (underlay == 0
//										    && tile_layer1_shape[z][tile_x][tile_y] != 0)
//											flag = false;
//										if (overlay > 0
//										    && !OverLayFlo317.overLayFlo317s[overlay - 1].aBoolean393)
//											flag = false;
//										if (flag && j19 == k19 && j19 == l19
//										    && j19 == i20)
//											anIntArrayArrayArray135[z][tile_x][tile_y] |= 0x924;
//									}
//									tile_layer0_colour[z][tile_x][tile_y] = colour;
//									int i22 = 0;
//									if (j21 != -1)
//										i22 = Texture.hsl2rgb[method187(k21,
//										                                       96)];
//									if (overlay == 0) {
//										worldController.method279(z, tile_x, tile_y, 0, 0,
...
//										                          i22, 0);
//									} else {
//										int k22 = tile_layer1_shape[z][tile_x][tile_y] + 1;
//										byte byte4 = tile_layer1_orientation[z][tile_x][tile_y];
...
//										} else if((overlay-1) == 54){
//											k23 = overlay_flo.rgb;
//											j23 = -2;
//											textureId = -1;
//										}
//										worldController.method279(z, tile_x, tile_y, k22,
...
//						worldController
//							.method278(z, i10, j8, method182(j8, z, i10));
//					
//					
//				}
//				
...
//		}
//		
//		private void method175(int i, WorldController worldController,
//		                       CollisionMap class11, int j, int k, int l, int i1, int j1) {
//			/*
//		 * int mX = clientInstance.MapX - 6; int mY = clientInstance.MapY - 6;
//		 * int actualX = mX * 8 + l; int actualY = mY * 8 + i; int actualH = k;
//		 * if(!(actualX >= 2630 && actualX <= 2639 && actualY >= 4680 && actualY
//		 * <= 4690)//castle at starting point && !(actualX >= 2640 && actualX <=
//		 * 2643 && actualY >= 4680 && actualY <= 4689)//castle at starting point
//		 * && !(actualX >= 2630 && actualX <= 2636 && actualY >= 4676 && actualY
//		 * <= 4689)//castle at starting point && !(actualX >= 2629 && actualX <=
//		 * 2637 && actualY >= 4679 && actualY <= 4685)//castle at starting point
//		 * && !(actualX >= 2637 && actualX <= 2638 && actualY >= 4691 && actualY
//		 * <= 4692)//castle at starting point && !(actualX == 2635 && actualY ==
//		 * 4693) && !(actualX == 2634 && actualY == 4693) ) {
//		 */
...
//				l2 += unchecked((int)0x80000000);
//			byte byte0 = (byte) ((j1 << 6) + j);
//			if (j == 22) {
//				if (lowMem && !class46.hasActions && !class46.aBoolean736)
//					return;
//				Object obj;
//				if (class46.animId == -1 && class46.childrenIDs == null)
...
//				}
//				if (class46.aBoolean767 && class11 != null)
//					class11.flagObject(i, j1, l, j, class46.aBoolean757);
...
//				                          ((Animable) (obj7)), l, byte0, 0, anIntArray152[j1],i1);
//				return;
//			}
//			if (j == 5) {
//				int i4 = 16;
...
//				                          ((Animable) (obj10)), l, byte0, 0, 768,i1);
//			}
//			// }
//		}
//		
...
//		}
//		
//		public static bool method178(int i, int j) {
//			ObjectDef class46 = ObjectDef.forID(i);
//			if (j == 11)
//				j = 10;
//			if (j >= 5 && j <= 8)
...
//		}
//		
//		public void method179(int i, int j, CollisionMap[] aclass11, int l,
...
//		}
//		
//		public void method180(byte[] abyte0, int i, int j, int k, int l,
...
//					}
//					if (l1 <= 49) {
//						tile_layer1_type[l][k][i] = (byte)stream.readSignedByte();
//						tile_layer1_shape[l][k][i] = (byte) ((l1 - 2) / 4);
//						tile_layer1_orientation[l][k][i] = (byte) ((l1 - 2) + i1 & 3);
//					} else if (l1 <= 81)
//						aByteArrayArrayArray149[l][k][i] = (byte) (l1 - 49);
//					else
//						tile_layer0_type[l][k][i] = (byte) (l1 - 81);
//				} while (true);
//			}
//			do {
...
//		}
//		
//		public void method183(CollisionMap[] aclass11,
...
//					                          ((Animable) (obj1)), k4, k1, j5, j, i1,j1);
//				}
...
//				                          i3, j, byte1, i1, null, l2, 0, k1,j1);
//				if (class46.aBoolean767)
//					class11.flagObject(j, i, i1, k, class46.aBoolean757);
//				return;
//			}
//			if (k == 1) {
//				Object obj4;
...
//				                          ((Animable) (obj7)), i1, byte1, 0, anIntArray152[i],j1);
//				return;
//			}
//			if (k == 5) {
//				int j4 = 16;
...
//				                          ((Animable) (obj10)), i1, byte1, 0, 768,j1);
//			}
//		}
//		
//		public static bool method189(int i, byte[] iss, int i_250_) // xxx bad
//			// method,
//			// decompiled
//			// with JODE
//		{
//			bool abool = true;
//			Stream stream = new Stream(iss);
//			int i_252_ = -1;
//			for (;;) {
...
//		}
//		
//		public void method190(int i, CollisionMap[] aclass11, int j,
...
//		}
//		
//		private static int anInt123 = (int) (Random.Next() * 17D) - 8;
...
//		public int[][][] anIntArrayArrayArray129;
//		public byte[][][] tile_layer1_type;
//		public static int anInt131;
//		private static int anInt133 = (int) (Random.Next() * 33D) - 16;
...
//		private static int[] anIntArray137 = { 1, 0, -1, 0 };
//		private static int anInt138 = 323;
//		private int[][] anIntArrayArray139;
//		private static int[] anIntArray140 = { 16, 32, 64, 128 };
//		public byte[][][] tile_layer0_type;
//		private static int[] anIntArray144 = { 0, -1, 0, 1 };
...
//		private static int[] anIntArray152 = { 1, 2, 4, 8 };
	}
}