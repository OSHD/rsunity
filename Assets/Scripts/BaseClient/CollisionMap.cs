...
namespace RS2Sharp
{
	...
	public class CollisionMap
	{
		...
		public CollisionMap(int a = 0, int b = 0)
		{
			anInt290 = 0;
			anInt291 = 0;
			anInt292 = a;
			anInt293 = b;
			anIntArrayArray294 = NetDrawingTools.CreateDoubleUIntArray(anInt292, anInt293);// new int[anInt292][anInt293];
			method210();
		}
		...
		public void flagObject(int i, int j, int k, int l, bool flag)
		{
		return;
			k -= anInt290;
			i -= anInt291;
		...
		public void method212(bool flag, int j, int k, int l, int i1, int j1)
		{
			int k1 = 256;
			if (flag)
				k1 += 0x20000;
		...
		{
			anIntArrayArray294[i][j] |= (uint)k;
		}

		public void method215(int i, int j, bool flag, int k, int l)
		{
			k -= anInt290;
			l -= anInt291;
			if (j == 0)
		...
		public void method216(int i, int j, int k, int l, int i1, bool flag)
		{
			int j1 = 256;
			if (flag)
				j1 += 0x20000;
		...
		{
			anIntArrayArray294[j][k] &= (uint)(0xffffff - i);
		}
		...
		public bool method219(int i, int j, int k, int i1, int j1, int k1)
		{
			if (j == i && k == k1)
				return true;
			j -= anInt290;
		...
		public bool method220(int i, int j, int k, int l, int i1, int j1)
		{
			if (j1 == i && k == j)
				return true;
			j1 -= anInt290;
		...
		public bool method221(int i, int j, int k, int l, int i1, int j1,
								 int k1)
		{
			int l1 = (j + j1) - 1;
			int i2 = (i + l) - 1;
		...
		public uint[][] anIntArrayArray294;
	}
}
