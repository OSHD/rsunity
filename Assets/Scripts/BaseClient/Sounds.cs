...
namespace RS2Sharp
{
		...
		private int method245(int i)
    {
        ...
        for(int l1 = 44; l1 < k1 + 44; l1++)
            aByteArray327[l1] = unchecked((byte)-128);
        ...
        if(i > 1)
        {
            ...
            {
                int l2 = (j1 - i1) * k3;
               // Array.Copy(aByteArray327, i1, aByteArray327, i1 + l2, j1 - i1);
					Buffer.BlockCopy(aByteArray327,i1, aByteArray327,i1 + l2, j1 - i1);
            }
		...
		private static Sounds[] aSoundsArray325s = new Sounds[5000];
