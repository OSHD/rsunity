...
using System.Text;
	...
	public class Packet
	{
		...
		public void writeQWord(long l)
		{
			...
			{
			UnityEngine.Debug.Log (runtimeexception.Message);
			}
		}
		...
		public void writeString(String s)
		{
			...
			Array.Copy(ASCIIEncoding.ASCII.GetBytes(s), 0, buffer, currentOffset, s.Length);
		...
		{
			if(sbuffer != null) return sbuffer[currentOffset++] & 0xff;
		...
		{
			currentOffset += 2;
		if(sbuffer != null) return ((sbuffer[currentOffset - 2] & 0xff) << 8) + (sbuffer[currentOffset - 1] & 0xff);
		...
		public String readString()
		{
			...
			return ASCIIEncoding.ASCII.GetString(buffer, i, currentOffset - i - 1);
		}
		...
		public byte[] readBytes()
		{
			...
			Array.Copy(buffer, i, abyte0, i - i, currentOffset - 1 - i);
			return abyte0;
		}
		...
		if(sbuffer != null)
		{
			int i = sbuffer[currentOffset] & 0xff;
			if (i < 128)
		...
		public void doKeys()
		{
			...
			currentOffset = 0;
			writeWordBigEndian(abyte0.Length);
			writeBytes(abyte0, abyte0.Length, 0);
		}
...
//        0x3fffffff, 0x7fffffff, -1
		...
		public RS2Sharp.ISAACRandomGen encryption;
